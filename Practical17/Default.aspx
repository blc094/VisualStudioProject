<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_19012011094_Practical17.Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="_19012011094_Practical17.DataSetTableAdapters.MyDataTableAdapter">
                <InsertParameters>
